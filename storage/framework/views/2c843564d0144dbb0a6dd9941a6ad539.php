...
var mobile = window.intlTelInput(document.querySelector("#phone"), {
  ...
  $("input[name='phone[full]'").val(fullnumber);
    // alert(fullnumber)
...
<?php /**PATH /media/rawash/New Volume1/Dev/Laravel-RiydhTrips/modules/Layout/app.blade.php ENDPATH**/ ?>