    ...
    <div class="<?php echo e($container_class ?? 'container'); ?>">
        ...
        <div class="content d-block">
            ...
            <div class="row align-items-center">
                ...
                <div class="header-left col-md-8 col-sm-6 col-12">
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="srch_bx">
                        <form action="<?php echo e(route("tour.search")); ?>" class="form bravo_form" method="get">
                            <input type="search" name="service_name" placeholder="Search">
                            <span class="srch_icn"><button type="submit" class="border-0 bg-transparent"><i class="fa fa-search" aria-hidden="true"></i></button></span>
            ...
            <div class="header-right">
                ...
                <ul class="topbar-items">
                    ...
                    <li class="signup-item">
                        ...
                        <a href="#register" data-toggle="modal" data-target="#register" class="signup"><?php echo e(__('Sign
                            Up')); ?></a>
                    ...
                    <li class="login-item dropdown">
                        ...
                        <ul class="dropdown-menu text-left">
                            ...
                            <li class="<?php if(Auth::user()->hasPermission('dashboard_vendor_access')): ?> menu-hr <?php endif; ?>">
                                ...
                                <a href="<?php echo e(route('user.profile.index')); ?>"><i class="icon ion-md-construct"></i> <?php echo e(__("My
                                    profile")); ?></a>
                            ...
                            <li class="menu-hr"><a href="<?php echo e(route('user.chat')); ?>"><i class="fa fa-comments"></i>
                            ...
                            <li class="menu-hr"><a href="<?php echo e(route('user.change_password')); ?>"><i class="fa fa-lock"></i>
                                    <?php echo e(__("Change password")); ?></a></li>

                            <?php if(Auth::user()->hasPermission('dashboard_access')): ?>

                            <li class="menu-hr"><a href="<?php echo e(route('admin.index')); ?>"><i class="icon ion-ios-ribbon"></i>
    ...
    <div class="bravo-menu-mobile" style="display:none;">
        ...
        <div class="user-profile">
            ...
            <ul>
                ...
                <li><a href="<?php echo e(route('vendor.dashboard')); ?>"><i class="icon ion-md-analytics"></i> <?php echo e(__("Vendor
                        Dashboard")); ?></a></li>
...
</div><?php /**PATH /media/rawash/New Volume1/Dev/Laravel-RiydhTrips/themes/BC/Layout/parts/header.blade.php ENDPATH**/ ?>