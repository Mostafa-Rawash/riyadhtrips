    ...
    <div class="g-faq">
        ...
        <?php $__currentLoopData = $translation->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item">
                ...
                <div class="body">
                    <?php echo nl2br(clean($item['content'])); ?>

                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
<?php endif; ?><?php /**PATH /media/rawash/New Volume/Dev/Laravel-RiydhTrips/themes/BC/Tour/Views/frontend/layouts/details/tour-faqs.blade.php ENDPATH**/ ?>