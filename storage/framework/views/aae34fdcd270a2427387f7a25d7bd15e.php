...
<head>
    ...
    <script src="<?php echo e(asset('libs/tinymce/js/tinymce/tinymce.min.js')); ?>"></script><script>
      tinymce.init({
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right">
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Powered By')); ?> <a
                            href="<?php echo e(__('https://riyadhtrips.com/')); ?>" target="_blank"
                        ><?php echo e(__('Riyadh Trips.')); ?></a>
                    </div>
                </div>
            </div>
        </footer>
...
<?php /**PATH /media/rawash/New Volume1/Dev/Laravel-RiydhTrips/modules/Layout/admin/app.blade.php ENDPATH**/ ?>