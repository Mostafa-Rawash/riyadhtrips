            ...
            <div class="review-form">
                ...
                <div class="form-wrapper">
                    ...
                    <form action="<?php echo e(route('review.store')); ?>" class="needs-validation" novalidate method="post">
                        ...
                        <?php endif; ?>
                        <?php if(setting_item("review_enable_recaptcha")): ?>
                            <div class="form-group">
...
<?php endif; ?>
<?php /**PATH /media/rawash/New Volume/Dev/Laravel-RiydhTrips/themes/BC/Review/Views/frontend/form.blade.php ENDPATH**/ ?>