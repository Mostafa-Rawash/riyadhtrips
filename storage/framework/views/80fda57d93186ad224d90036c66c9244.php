<tr>
    ...
    <td width="2%">
        ...
        <a href="<?php echo e(route('user.booking.downloadInvoice',['code'=>$booking->code])); ?>" class="btn btn-xs btn-primary btn-info-booking open-new-window mt-1">

            <i class="fa fa-download" aria-hidden="true"></i><?php echo e(__("Download")); ?>
...
<?php /**PATH /home/riyaoeiu/public_html/themes/Base/Tour/Views/frontend/bookingHistory/loop.blade.php ENDPATH**/ ?>