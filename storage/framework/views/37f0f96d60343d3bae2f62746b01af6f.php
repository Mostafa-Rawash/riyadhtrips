            ...
            <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                ...
                <div class="form-content">
                    ...
                    <div class="form-section-group form-group" v-if="packages.length">
                        <h4 class="form-section-title"><?php echo e(__('Packages:')); ?></h4>
                        ...
                        <div class="form-group" v-for="(type, index) in packages" :key="index">
                            <div class="extra-price-wrap d-flex justify-content-between">
                                ...
                                <div class="flex-shrink-0">
                                    ...
                                    <div v-else>
                                        <?php echo e(__('No start times available')); ?>
                    ...
                    <div class="form-section-group form-group" v-if="discount_by_people_output.length">
                        ...
                        <h4 class="form-section-title"><?php echo e(__('Discounts:')); ?></h4>
                        ...
                        <div class="extra-price-wrap d-flex justify-content-between" v-for="(type,index) in discount_by_people_output">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="render" v-if='type.to'>
                                    ...
                                    {{type.from}} - {{type.to}} <?php echo e(__('guests')); ?>
                                ...
                                <span class="render" v-else>
                                    ...
                                    <?php echo e(__('from')); ?> {{type.from}} <?php echo e(__('guests')); ?>
            ...
            <div class="form-send-enquiry" v-show="enquiry_type=='enquiry'">
                ...
                <div class="enquiry-form">
                    <div class="enquiry-form-header">
                        <h5 class="enquiry-form-title"><?php echo e(__("Plan your package!")); ?></h5>
                        <h5 class="enquiry-form-description"><?php echo e(__("For a truly unique experience, contact one of our travel advisors via WhatsApp or enter your details and we will contact you to help customise your package!")); ?></h5>
                    ...
                    <p class="or-spacing"><?php echo e(__("Or")); ?></p>
                    <div class="enquiry-form-body">
                        <h5 class="enquiry-contact-form-title"><?php echo e(__("Contact Details")); ?></h5>
                        <input type="hidden" name="service_id" value="<?php echo e($row->id); ?>">
                        <input type="hidden" name="service_type" value="<?php echo e($service_type ?? 'tour'); ?>">
                        <div class="form-group">
                            <label for="enquiry_name"><?php echo e(__("Name *")); ?></label>
                            <input type="text" class="form-control" id="enquiry_name" value="<?php echo e($user->display_name ?? ''); ?>" name="enquiry_name" placeholder="<?php echo e(__("Name *")); ?>">
                        </div>
                        <div class="form-group">
                            <label for="enquiry_email"><?php echo e(__("Email *")); ?></label>
                            <input type="text" class="form-control" id="enquiry_email" value="<?php echo e($user->email ?? ''); ?>" name="enquiry_email" placeholder="<?php echo e(__("Email *")); ?>">
                        </div>
                        <div class="form-group">
                            <label for="enquiry_phone"><?php echo e(__("Phone")); ?></label>
                            <input type="text" class="form-control" id="enquiry_phone" value="<?php echo e($user->phone ?? ''); ?>" name="enquiry_phone" placeholder="<?php echo e(__("Phone")); ?>">
                        </div>
                        <div class="form-group">
                            <label for="enquiry_note"><?php echo e(__("Note")); ?></label>
                            <textarea class="form-control" id="enquiry_note" placeholder="<?php echo e(__("Note")); ?>" name="enquiry_note"></textarea>
                        </div>
...
</script><?php /**PATH /media/rawash/New Volume/Dev/Laravel-RiydhTrips/themes/BC/Tour/Views/frontend/layouts/details/tour-form-book.blade.php ENDPATH**/ ?>