<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="price" class="form-control" value="<?php echo e(old('price',$row->price)); ?>"
                        placeholder="<?php echo e(__(" Tour Price")); ?>">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sale_price" class="form-control"
                        value="<?php echo e(old('sale_price',$row->sale_price)); ?>" placeholder="<?php echo e(__(" Tour Sale Price")); ?>">
        ...
        <div class="form-group">
            ...
            <label><input type="checkbox" name="enable_person_types" <?php if(!empty($row->meta->enable_person_types)): ?>
                checked <?php endif; ?> value="1"> <?php echo e(__('Enable Person Types')); ?>
        ...
        <div class="form-group-item" data-condition="enable_person_types:is(1)">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="g-lang">
                                ...
                                <input type="text" name="person_types[<?php echo e($key); ?>][name<?php echo e($key_lang); ?>]" class="form-control"
                                    value="<?php echo e($person_type['name'.$key_lang] ?? ''); ?>" placeholder="<?php echo e(__('Eg: Adults')); ?>">

                                <input type="text" name="person_types[<?php echo e($key); ?>][desc<?php echo e($key_lang); ?>]" class="form-control"
                                    value="<?php echo e($person_type['desc'.$key_lang] ?? ''); ?>"
                            ...
                            <input type="text" name="person_types[<?php echo e($key); ?>][name]" class="form-control"
                                value="<?php echo e($person_type['name'] ?? ''); ?>" placeholder="<?php echo e(__('Eg: Adults')); ?>">

                            <input type="text" name="person_types[<?php echo e($key); ?>][desc]" class="form-control"
                                value="<?php echo e($person_type['desc'] ?? ''); ?>" placeholder="<?php echo e(__('Description')); ?>">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" min="0" name="person_types[<?php echo e($key); ?>][min]" class="form-control"
                                value="<?php echo e($person_type['min'] ?? 0); ?>" placeholder="<?php echo e(__(" Minimum per booking")); ?>">

                        </div>

                        <div class="col-md-2">

                            <input type="number" min="0" name="person_types[<?php echo e($key); ?>][max]" class="form-control"
                                value="<?php echo e($person_type['max'] ?? 0); ?>" placeholder="<?php echo e(__(" Maximum per booking")); ?>">

                        </div>

                        <div class="col-md-2">

                            <input type="text" min="0" name="person_types[<?php echo e($key); ?>][price]" class="form-control"
                                value="<?php echo e($person_type['price'] ?? 0); ?>" placeholder="<?php echo e(__(" per 1 item")); ?>">
            ...
            <div class="text-right">
                ...
                <span class="btn btn-info btn-sm btn-add-item"><i class="icon ion-ios-add-circle-outline"></i> <?php echo e(__('Add
                    item')); ?></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="g-lang">
                                ...
                                <input type="text" __name__="person_types[__number__][name<?php echo e($key); ?>]"
                                    class="form-control" value="" placeholder="<?php echo e(__('Eg: Adults')); ?>">

                                <input type="text" __name__="person_types[__number__][desc<?php echo e($key); ?>]"
                                    class="form-control" value="" placeholder="<?php echo e(__('Description')); ?>">
                            ...
                            <input type="text" __name__="person_types[__number__][name]" class="form-control" value=""
                                placeholder="<?php echo e(__('Eg: Adults')); ?>">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" min="0" __name__="person_types[__number__][min]" class="form-control"
                                value="" placeholder="<?php echo e(__(" Minimum per booking")); ?>">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" min="0" __name__="person_types[__number__][max]" class="form-control"
                                value="" placeholder="<?php echo e(__(" Maximum per booking")); ?>">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" min="0" __name__="person_types[__number__][price]" class="form-control"
                                value="" placeholder="<?php echo e(__(" per 1 item")); ?>">
        ...
        <?php if(is_default_lang()): ?>
        <h3 class="panel-body-title"><?php echo e(__('Packages')); ?></h3>

        <div class="form-group">
            <label>
                <input type="checkbox" name="enable_packages" <?php if(!empty($row->meta->enable_packages)): ?> checked <?php endif; ?>
                value="1">
                <?php echo e(__('Enable Packages')); ?>

            </label>
        </div>

        <div class="form-group-item" data-condition="enable_packages:is(1)">
            <label class="control-label"><?php echo e(__('Package Types')); ?></label>

            <div class="g-items">
                <?php if(!empty($packages = old('packages', $row->meta->packages ?? ""))): ?>
                ...
                <div class="item" data-number="<?php echo e($key); ?>">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="packages[<?php echo e($key); ?>][name]" class="form-control"
                                value="<?php echo e($package['name'] ?? ''); ?>" placeholder="<?php echo e(__('Package Name')); ?>">
                            <textarea name="packages[<?php echo e($key); ?>][description]" class="form-control"
                                placeholder="<?php echo e(__('Package Description')); ?>"><?php echo e($package['description'] ?? ''); ?></textarea>
                        </div>
                        <!-- Price -->
                        <div class="col-md-2">
                            <input type="text" name="packages[<?php echo e($key); ?>][price]" class="form-control"
                                value="<?php echo e($package['price'] ?? ''); ?>" placeholder="<?php echo e(__('Price per Person')); ?>">
                        </div>
                        <!-- Time Slots -->
                        <div class="col-md-3">
                            <div class="time-slots">
                                <?php if(!empty($package['start_times'])): ?>
                                <?php $__currentLoopData = $package['start_times']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeKey => $startTime): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="time-slot" data-time-key="<?php echo e($timeKey); ?>">
                                    <input type="time" name="packages[<?php echo e($key); ?>][start_times][<?php echo e($timeKey); ?>]"
                                        class="form-control" value="<?php echo e($startTime); ?>"
                                        placeholder="<?php echo e(__('Tour Start Time')); ?>">
                                ...
                                <div class="time-slot" data-time-key="0">
                                    <input type="time" name="packages[<?php echo e($key); ?>][start_times][0]" class="form-control"
                                        placeholder="<?php echo e(__('Tour Start Time')); ?>">
                                    <span class="btn btn-danger btn-sm btn-remove-time">
                                        <i class="fa fa-trash"></i>
                                    </span>
                            ...
                            <span class="btn btn-info btn-sm btn-add-time"><?php echo e(__('Add Time')); ?></span>
                        </div>
                        <!-- Remove Package -->
                        <div class="col-md-2">
            ...
            <div class="text-right">
                <span class="btn btn-info btn-sm btn-add-item">
                    <i class="icon ion-ios-add-circle-outline"></i> <?php echo e(__('Add Package')); ?>
        ...
        <div class="form-group app_get_locale">
            ...
            <label><input type="checkbox" name="enable_extra_price" <?php if(!empty($row->meta->enable_extra_price)): ?> checked
                <?php endif; ?> value="1"> <?php echo e(__('Enable extra price')); ?>
                ...
                <div class="item" data-number="<?php echo e($key); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" min="0" name="extra_price[<?php echo e($key); ?>][price]" class="form-control"
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="extra_price[<?php echo e($key); ?>][type]" class="form-control">
                                ...
                                <option <?php if($extra_price['type']=='per_day' ): ?> selected <?php endif; ?> value="per_day"><?php echo e(__("Per
                                    day")); ?></option>
                            ...
                            <label>
                                ...
                                <input type="checkbox" min="0" name="extra_price[<?php echo e($key); ?>][per_person]" value="on"
                                    <?php if($extra_price['per_person'] ?? '' ): ?> checked <?php endif; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" min="0" name="discount_by_people[<?php echo e($key); ?>][to]" class="form-control"
                                value="<?php echo e($item['to']); ?>" placeholder="<?php echo e(__('To')); ?>">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="discount_by_people[<?php echo e($key); ?>][type]" class="form-control">
                                ...
                                <option <?php if($item['type']=='percent' ): ?> selected <?php endif; ?> value="percent"><?php echo e(__("Percent
                                    (%)")); ?></option>
...
</div><?php /**PATH /media/rawash/New Volume1/Dev/Laravel-RiydhTrips/modules/Tour/Views/admin/tour/pricing.blade.php ENDPATH**/ ?>