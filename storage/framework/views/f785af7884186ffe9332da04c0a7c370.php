        ...
        <div class="modal-content enquiry_form_modal_form">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="travel_from" value="<?php echo e($user->travel_from ?? ''); ?>" name="enquiry_travel_from" class="form-control" placeholder="<?php echo e(__("Travel From *")); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex">
                        <div class="mr-2">
                            ...
                            <input type="number" id="adult" value="<?php echo e($user->adult ?? ''); ?>" name="enquiry_adult" class="form-control" min="0">
                        </div>
                        <div>
                            <label for="children">Children</label>
                            <input type="number" id="children" value="<?php echo e($user->children ?? ''); ?>" name="enquiry_children" class="form-control" min="0">
                        </div>
                    </div>
                </div>
...
</div><?php /**PATH /media/rawash/New Volume/Dev/Laravel-RiydhTrips/themes/BC/Booking/Views/frontend/global/enquiry-form.blade.php ENDPATH**/ ?>